    ...
    <form id="form1" runat="server">
        <div class="login-box">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtUser" runat="server" CssClass="input-field" placeholder="Enter your username" />
            </div>

            <div class="input-group password-container">
                <label for="txtPass">Password</label>
                <asp:TextBox ID="txtPass" runat="server" TextMode="Password" CssClass="input-field" placeholder="Enter your password" />
            ...
            <div class="register-link">
                <asp:HyperLink ID="lnkRegister" runat="server" NavigateUrl="Registration.aspx?role=Customer">
